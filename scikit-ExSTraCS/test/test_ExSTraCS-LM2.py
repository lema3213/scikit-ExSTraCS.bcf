...
model = ExSTraCS(learning_iterations=learning_iterations,chi=0,rule_specificity_limit=20, N=N,level=level,log_dir=log_dir, log_trainingfile_name=log_trainingfile_name)
